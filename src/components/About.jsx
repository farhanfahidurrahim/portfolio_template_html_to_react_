...
<div class="slider-area ">
    ...
    <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="https://preview.colorlib.com/theme/personalportfolio/index.html">Home</a></li>
    <li class="breadcrumb-item"><a href="https://preview.colorlib.com/theme/personalportfolio/about.html#">About me</a></li>
    </ol>
    </nav>
    </div>
    </div>
...
<section class="about-area section-paddingt30">
    ...
    <div class="send-cv">
    <a href="https://preview.colorlib.com/theme/personalportfolio/about.html#">hire@colorlib.com</a>
...
<div class="contact-info-area w-padding2" data-background="assets/img/section_bg04.jpg" style={{backgroundImage: 'url(assets/img/section_bg04.jpg)'}}>
    <div class="container">
    ...
    <form action="https://preview.colorlib.com/theme/personalportfolio/about.html#" class="contact-wrapper">
